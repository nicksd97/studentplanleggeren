        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <a href="#" className="text-brand-soft hover:text-brand-accent transition-all duration-300 hover:scale-110 inline-block" aria-label="Instagram">
              ...
              {/* TikTok */}
              <a href="#" className="text-brand-soft hover:text-brand-accent transition-all duration-300 hover:scale-110 inline-block" aria-label="TikTok">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Email */}
              <a href="mailto:hei@studentplanlegger.no" className="text-brand-soft hover:text-brand-accent transition-all duration-300 hover:scale-110 inline-block" aria-label="E-post">
